...
for(let i in objt){
    let filmesObjeto = objt[i]

    let filmesTitulo = filmesObjeto.Title
    let filmesPlot = filmesObjeto.Plot
    let filmesGenero = new Array (filmesObjeto.Genre)
    let filmesLinguagem = new Array (filmesObjeto.Language)

    console.log('----------------')
    console.log(filmesTitulo)
    console.log(`Gênero: ${filmesGenero}`)
    console.log(`Linguagem: ${filmesLinguagem}`)
    console.log(`Plot: ${filmesPlot}`)
